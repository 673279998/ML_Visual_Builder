...
## 写在前面
声明：本项目主要代码编写工作由AI完成。
最初想法是作者在工作和学习中接触到很多机器学习的事情，发现现有的机器学习python框架已经十分完善，但是这些框架的使用都需要编写代码，而作者认为这对于很多人来说存在一个门槛，需要一定的编程基础，而spss、origin等软件功能强大，但存在算法老旧、更新缓慢、新版软件难以获取的问题。加之近期dify、coze等平台的热门，就想到将python的机器学习算法框架通过可视化、模块化的方式展现出来，让使用者更直观看到机器学习工作流程，并且能够简单地自由配置。
